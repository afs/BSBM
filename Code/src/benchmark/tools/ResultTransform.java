...
public class ResultTransform {
    ...
    private static final String[] sizes = { "250k", "1m", "5m", "25m" } ;
    // Explore use case.
    private static final String queryLink = "http://wifo5-03.informatik.uni-mannheim.de/bizer/berlinsparqlbenchmark/spec/ExploreUseCase/index.html#queryTripleQ" ;
        // http://www4.wiwiss.fu-berlin.de/bizer/BerlinSPARQLBenchmark/spec/index.html#queryTripleQ"; 
